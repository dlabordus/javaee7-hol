...
public class MovieWriter implements MessageBodyWriter<Movie> {
    ...
    public void writeTo(Movie t, Class<?> type1, Type type, Annotation[] antns, MediaType mt, MultivaluedMap<String, Object> mm, OutputStream out) throws IOException, WebApplicationException {
